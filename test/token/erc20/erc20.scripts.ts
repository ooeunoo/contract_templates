export const Scripts = {
  metadata: {
    ...
    check_pre_mint_receiver:
      "returns the balance of the address that received the premint amount.",
  },
  standard: {
    check_transfer:
      "transfer, transfers _value amount of tokens to address _to, and MUST emit the Transfer event.",
